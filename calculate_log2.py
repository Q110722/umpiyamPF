...
def cal_log2(plot_graph, Total_STAT_ARRAY, NET_STAT, ring, VI_level, deal_time_ref, delay):
...
#-------------------------------------------------------------------------------------------------------------------------------
            ...
            if Condition_ARRAY[9] <= t%(120*1000) < 120*1000:
                ...
                # Resonance VI
                if Resonance_Delay <= 0 and VI_level[7] > 0:
                    if Res_stack < 4:
                    ...
                    Resonance_Delay = (15*Cool_R-Cool)*1000 + 200
                    Resonance_stack -= 1
                ...
                if Resonance_Delay <= 0 and VI_level[7] == 0:
                    ...
                    Resonance_Delay = (15*Cool_R-Cool)*1000 + 500
                    Resonance_stack -= 1
                    Resonance_times_used += Resonance_Num
                    Resonance_attacks += 6*Resonance_Num
                    Material_stack += 2*Resonance_Num

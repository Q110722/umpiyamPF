...
def cal_DPM_6th4_log_rev_34_1st(plot_graph, Total_STAT_ARRAY, NET_STAT, ring, VI_level, deal_time_ref, delay):
            ...
            if Condition_ARRAY[9] <= t%(120*1000) < 120*1000:
                ...
                if Resonance_Delay <= 0 and Discharge_Used == 1 and VI_level[7] > 0:
                    if Res_stack < 4:
                        ...
                        Res_stack = 0
                        Resonance_attacks += 10*Resonance_Num
...
# Plot graph ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if plot_graph == 2:
        ...
        # Test_graph
        axs[0].bar(time_int,Deal_Int[19,:],width=0.6, color = 'black')

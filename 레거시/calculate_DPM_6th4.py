...
def cal_DPM_6th4(plot_graph, Total_STAT_ARRAY, NET_STAT, ring, VI_level, deal_time_ref, delay):
...
#-------------------------------------------------------------------------------------------------------------------------------
            ...
            if Condition_ARRAY[9] <= t%(120*1000) < 120*1000:
                ...
                # Resonance
                if Resonance_Delay <= 0 and Discharge_Used == 1:
                ...
                if Cardinal_Blast_Delay <= 0 and Active == 1 and VI_level[5] > 0:
                    ...
                    Cardinal_Blast_Delay = 450 - iteration_time
               ...
               # Cardinal Discharge VI
                if Cardinal_Discharge_Delay <= 0 and Active == 1 and Cardinal_between_Delay <= 0 and VI_level[6] > 0:
                    ...
                    Cardinal_Discharge_Delay = 450 - iteration_time
        ...
        for i in range(len(Deal)):
            for j in range(len(Deal[i])):
                ...
                Deal[i][j] *= 4 * (1.3 * 1 * 1.2 * (50 + 5/2)/100 * (1 + 0.86)/2) / (10**12)

...
def cal_log_assault_fix3(plot_graph, Total_STAT_ARRAY, NET_STAT, ring, VI_level, deal_time_ref, delay):
...
#-------------------------------------------------------------------------------------------------------------------------------
            ...
            if Condition_ARRAY[9] <= t%(120*1000) < 120*1000:
                ...
                if Forsaken_buff == 0:        
                    ...
                    if Blast_stack >= Blast_stack2 and Discharge_stack >= Discharge_stack2 and VI_level[8] > 0 and VI_level[7] > 0:
                    ...
                    elif VI_level[8] > 0 and VI_level[7] > 0:
                        Assault = 0
    ...
    with open('log.txt','w') as file:
        ...
        file.write('콤보 어썰트\n')
        file.write(f"데미지 점유율: {Deal_Cumulative[20]/sum*100:.3f}%\n")
        file.write(f"사용횟수: {Skill_log_times[18]}\n")
        file.write(f"공격횟수: {Skill_log_attacks[18]}\n\n")
